        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-20 sm:pt-24 sm:pb-24 lg:pt-32 lg:pb-32">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="cursor-pointer h-11 px-8 bg-slate-900 text-slate-50 hover:bg-slate-900/90 dark:bg-slate-100 dark:text-slate-900 dark:hover:bg-slate-200 inline-flex items-center justify-center rounded-md text-base font-medium transition-colors">
                Explore Products
              </button>
              <button className="cursor-pointer h-11 px-8 bg-white text-slate-900 border border-slate-200 hover:bg-slate-100 dark:bg-slate-800 dark:text-slate-100 dark:border-slate-700 dark:hover:bg-slate-700 inline-flex items-center justify-center rounded-md text-base font-medium transition-colors">
                Request a Quote
              </button>
            </div>
          </div>
