  ...
  return (
    <>
      <div className="space-y-5 xl:mx-0 mx-3">
        ...
        <div className="flex lg:flex-row flex-col h-full w-full items-stretch gap-5 justify-between">
          <Card className="p-5 w-full h-full shadow-sm">
            ...
            <Separator className={"my-2"} />
            <CardContent className="flex flex-wrap gap-3 w-full">
              <ul className="max-w-md w-full space-y-1 text-body list-inside">
                {primary.map((item) => (
                  <li key={item.id} className="flex items-center text-lg">
                    <svg
                      className="w-6 h-6 text-fg-success me-1.5 shrink-0"
                      aria-hidden="true"
          ...
          <Card className="p-5 w-full h-full shadow-sm hover:shadow-lg">
            <CardHeader>
              {" "}
              <h1 className="text-gray-900 text-3xl font-semibold">
                Popular Product Range
